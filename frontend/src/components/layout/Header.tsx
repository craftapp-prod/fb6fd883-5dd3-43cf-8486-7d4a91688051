...
const Header = () => {
  ...
  return <header className="bg-white shadow-sm sticky top-0 z-10" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_8836a104">
        ...
        <div className="flex justify-between h-16 items-center" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_24ef0402">
          ...
          <div className="flex-shrink-0 flex items-center" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_e994adc1">
            ...
            <div className="flex items-center space-x-3" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_4b239867">
              ...
              <Link href="/customer/fb6fd883-5dd3-43cf-8486-7d4a91688051/register/" className="flex items-center bg-primary-600 text-white hover:bg-primary-700 px-4 py-2 rounded-md text-sm font-medium transition selected-element" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_13f9bb64">
                EduAdmin
              </Link>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_60b09d91">{isAuthenticated ? <>
                ...
                <button onClick={logout} className="flex items-center text-gray-600 hover:text-primary-600 px-3 py-2 rounded-md text-sm font-medium transition" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_0d8758ed">
                ...
                <Link href="/customer/fb6fd883-5dd3-43cf-8486-7d4a91688051/register/" className="flex items-center bg-primary-600 text-white hover:bg-primary-700 px-4 py-2 rounded-md text-sm font-medium transition selected-element" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_78b39659">

                  <FiLogIn className="mr-1" />
                  Login
                </Link>

                <Link href="/customer/fb6fd883-5dd3-43cf-8486-7d4a91688051/register/" className="flex items-center bg-primary-600 text-white hover:bg-primary-700 px-4 py-2 rounded-md text-sm font-medium transition selected-element" data-path="frontend/src/components/layout/Header.tsx" data-page="frontend/src/app/page.tsx" id="el_50f15462">
