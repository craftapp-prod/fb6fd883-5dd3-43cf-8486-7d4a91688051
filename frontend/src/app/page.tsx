...
export default function Home() {
  return (
    <div className="flex flex-col items-center" data-path="frontend/src/app/page.tsx" id="el_d6e32a49">
        ...
        <div className="container px-4 md:px-6" data-path="frontend/src/app/page.tsx" id="el_6500cef7">
          <div className="flex flex-col items-center space-y-6 text-center" data-path="frontend/src/app/page.tsx" id="el_ffc36494">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center" data-path="frontend/src/app/page.tsx" id="el_1e33d9c2">
              <Link
                href="/demo"
                className="inline-flex h-11 items-center justify-center rounded-md bg-primary-600 px-8 text-sm font-medium text-white shadow transition-colors hover:bg-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500" data-path="frontend/src/app/page.tsx" id="el_3428f272">

                Request Demo
              </Link>
              <Link
                href="/features"
                className="inline-flex h-11 items-center justify-center rounded-md border border-gray-300 bg-white px-8 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500" data-path="frontend/src/app/page.tsx" id="el_2e21a8a0">

                Learn More
              </Link>
            </div>
            <div className="mt-8" data-path="frontend/src/app/page.tsx" id="el_627a8a7c">
              <img
                ...
                className="rounded-xl shadow-lg max-h-[400px] object-cover" data-path="frontend/src/app/page.tsx" id="el_4045dd0e" />
      ...
      <section className="w-full py-12 md:py-24 bg-white" data-path="frontend/src/app/page.tsx" id="el_90217807">
        <div className="container px-4 md:px-6" data-path="frontend/src/app/page.tsx" id="el_f851235b">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 sm:grid-cols-2 lg:grid-cols-3" data-path="frontend/src/app/page.tsx" id="el_cbebd450">
            ...
            <div key={index} className="flex flex-col items-start space-y-3 rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md" data-path="frontend/src/app/page.tsx">
      ...
      <section className="w-full py-12 md:py-24 bg-white" data-path="frontend/src/app/page.tsx" id="el_340019fe">
        <div className="container px-4 md:px-6" data-path="frontend/src/app/page.tsx" id="el_08ca3978">
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-8 py-12 lg:grid-cols-3" data-path="frontend/src/app/page.tsx" id="el_4c89be98">
            ...
            <div key={index} className="flex flex-col rounded-lg border border-gray-200 bg-white p-6 shadow-sm" data-path="frontend/src/app/page.tsx">
                <div className="flex items-center gap-4" data-path="frontend/src/app/page.tsx">
                  <img
                  src={testimonial.image}
                  alt={testimonial.alt}
                  className="h-12 w-12 rounded-full object-cover" data-path="frontend/src/app/page.tsx" />
        ...
        <div className="container px-4 md:px-6" data-path="frontend/src/app/page.tsx" id="el_6db28d47">
          <div className="mx-auto max-w-[58rem] flex flex-col items-center justify-center space-y-6 text-center" data-path="frontend/src/app/page.tsx" id="el_260b4c16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center" data-path="frontend/src/app/page.tsx" id="el_c43d8dd0">
              <Link
                href="/register"
                className="inline-flex h-11 items-center justify-center rounded-md bg-primary-600 px-8 text-sm font-medium text-white shadow transition-colors hover:bg-primary-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500" data-path="frontend/src/app/page.tsx" id="el_facb39ae">
